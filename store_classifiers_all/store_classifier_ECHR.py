...
# Load labels
# ----------------------------
with open("result_llm/results_ECHR_full_train/gemma-7b-it_ECHR_start1-0_end-2500_2_3.json", "r") as f:
    data = json.load(f)
...
# Input pickle
# ----------------------------
results_file = "result_llm/results_ECHR_full_train/gemma-7b-it_ECHR_start1-0_end-2500_2_3.pickle"

with open(results_file, "rb") as f:
    results = pickle.load(f)

model_dir = "saved_model/saved_model_gemma_ECHR"
